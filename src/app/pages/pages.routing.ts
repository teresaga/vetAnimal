...
const pagesRoutes: Routes = [
    {
        ...
        children: [
	        ...
	        {path: 'clientes', component: ClientsComponent, canActivate: [VetGuard]},
            {path: 'tienda', component: ShopComponent, canActivate: [CajeroGuard]},
            {path: 'animales', component: AnimalsComponent, canActivate: [VetGuard]},
            {path: 'empleados', component: WorkersComponent , canActivate: [AdminGuard]},
            {path: 'proveedores', component: ProvidersComponent , canActivate: [AdminGuard]},
